...
.. _Source Code: https://github.com/rajivsarvepalli/warframe-metrics
.. _Documentation: https://warframe-metrics.readthedocs.io/
...
.. _pull request: https://github.com/rajivsarvepalli/warframe-metrics/pulls

Future Plans
------------

Adding more data analysis features to improve this library and some technologies used to predict stock market
trends.

Feel free to suggest any ideas through the `Issue Tracker`_ or any other of the listed means.

.. _Issue Tracker: https://github.com/rajivsarvepalli/warframe-metrics/issues
